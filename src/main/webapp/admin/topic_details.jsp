	...
	<div class="container" style="margin:8% auto;width:900px;">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<form>
					<input type="text" class="form-control" value="<%= post.getTitle() %>"><br>
                    <textarea name="content"class="form-control"><%= post.getContent() %></textarea><br>
                    <input type="text" class="form-control" value="<%= post.getCategory() %>"><br>
                    <input type="text" class="form-control" value="<%= post.getTimestamp() %>">
				</form>
			</div>
		</div>
	</div>
